...
function removeNotImplementedFeatureInCypress() {
    this.fs.delete(
        `${SERVER_SRC_DIR}${this.clientTestProject}/cypress/integration/account/reset-password-page.spec.ts`
    );
    this.fs.delete(
        `${SERVER_SRC_DIR}${this.clientTestProject}/cypress/integration/administration/administration.spec.ts`
    );
}

function updateTsConfigCypress() {
    this.replaceContent(
        `${SERVER_SRC_DIR}${this.clientTestProject}/cypress/tsconfig.json`,
        "./../../../../",
        "./../../",
        true
    );
