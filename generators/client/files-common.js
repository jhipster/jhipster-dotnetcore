...
function updateJestConf() {
  if (this.clientFramework === ANGULAR || this.clientFramework === REACT) {
    ...
    this.replaceContent(`${SERVER_SRC_DIR}${this.mainClientDir}/test/jest.conf.js`, `/${SERVER_SRC_DIR}${this.mainClientDir}`, '', true);
...
function updateEsLinIgnore() {
  ...
  if (this.protractorTests) {
    this.replaceContent(`${SERVER_SRC_DIR}${this.mainClientDir}/tsconfig.e2e.json`, `/${SERVER_SRC_DIR}${this.mainClientDir}`, '', true);
  }
}
